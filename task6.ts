...
let array:number[]= [2,-3,5,-7,8,-9,10];
let updatedarray:number[]= array.filter(n=> n>=0);
...
let arr4:number[]= [0,10,20,30,40];
let updatearr4:number[] = arr4.map(n=> (n*9/5)+32);
...
let arr5:number[]= [3,6,9,12,15,18];
let updatearr5:number[]= arr5.filter(n=> n%2!==0)
.map(n=> n*2);
