...
var quote = "People who have no hold over their process of thinking are likely to be ruined by liberty of thought.";
...
//
let nameArray = ["sahir", "Khawar", "Amir", "Fakhar", "zeeshan", "imtiaz", "Fizan"];
...
for (let i = 0; i < transport.length; i++) {
    if (transport[i] == "ToyotaGLI") {
        ...
        console.log(transport[i], "use thaiairways for visiting bankok");
    }
}
//Guest List: If you could invite anyone, living or deceased, to dinner, who would you invite? Make a list that includes at least three people you’d like to invite to dinner. Then use your list to print a message to each person, inviting them to dinner.
let guestList = ["Nadeem", "Shabana", "Yasmeen", "Saima", "nahid"];
...
let guestList1 = ["Nadeem", "Shabana", "Yasmeen", "Saima", "nahid"];
...
let guestList2 = ["Nadeem", "Shabana", "Yasmeen", "Saima", "nahid"];
...
let guestList3 = ["Nadeem", "Shabana", "Yasmeen", "naeem", "nahid"];
...
let guestList6 = ["Nadeem", "Shabana", "Yasmeen", "naeem", "nahid"];
